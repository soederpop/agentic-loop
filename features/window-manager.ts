  ...
  static tools = {
    ...
    wmSpawnTerminal: {
      ...
      schema: z.object({
        ...
        env: z.record(z.string(), z.string()).optional().describe('Environment variable overrides (merged with the process environment)'),
    ...
    wmSpawnLayout: {
      ...
      schema: z.object({
        windows: z.array(z.object({
          ...
          env: z.record(z.string(), z.string()).optional().describe('Environment variable overrides for terminal'),
          cols: z.number().int().positive().optional().describe('Initial terminal column count'),
          rows: z.number().int().positive().optional().describe('Initial terminal row count'),
          title: z.string().optional().describe('Window title'),
          width: z.union([z.number(), z.string()]).optional().describe('Width'),
