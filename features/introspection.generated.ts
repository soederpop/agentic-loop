...
setBuildTimeData('features.presenter', {
  "id": "features.presenter",
  "description": "Long-running presenter server kept alive by luca main. Serves the presenter HTML shell and a containerLink WebSocket so that `luca present` can skip the server boot and open windows instantly.",
  "shortcut": "features.presenter",
  "className": "Presenter",
  "methods": {
    "start": {
      "description": "",
    ...
    "buildPageUrl": {
      "description": "Build the full page URL for a given presentation",
      "parameters": {
        "opts": {
          "type": "{ url: string; title?: string; mode?: string }",
  ...
  "events": {
    "windowManagerConnected": {
      "name": "windowManagerConnected",
      "description": "Event emitted by Presenter",
      "arguments": {}
    },
    "windowManagerDisconnected": {
      "name": "windowManagerDisconnected",
      "description": "Event emitted by Presenter",
      "arguments": {}
    }
  },
