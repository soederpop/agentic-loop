...
This is a theoretical file layout.  Each subfolder generally contains documents of the same Model.
...
│   ├── Epic.md
│   └── Story.md
├── README.md                    # Generated: model documentation
...
The Query endpoint and method on the collection accepts a JSON format of a Query DSL for over the wire querying.

See [references/query-dsl-overview.md](./references/query-dsl-overview.md)
