...
**Output location:** Write to `$CWD/public/diagrams/`. Use a descriptive filename based on content: `modem-architecture.html`, `pipeline-flow.html`, `schema-overview.html`. The directory persists across sessions.

**Open in browser:**
- macOS: `open $CWD/public/diagrams/filename.html`
- Linux: `xdg-open $CWD/public/diagrams/filename.html`
