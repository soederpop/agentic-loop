...
Consult the [Content Model Readme](./docs/README.md) which is generated by the `cnotes summary` command and it explains the content model.

Consult the [Templates Folder](docs/templates) for examples of what goes into each model.
