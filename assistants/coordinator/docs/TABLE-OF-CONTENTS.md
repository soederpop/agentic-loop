...
- [Have 10 Users of the Agentic Loop](./goals/have-10-users-of-the-agentic-loop.md)
...
- [Communications Feature (Channel Inbox)](./ideas/communications-feature.md)
...
- [Blank Slate Onboarding Workflow](./ideas/workflows/blank-slate-onboarding.md)
- [Review / Status Briefing Workflow](./ideas/workflows/review-status-briefing.md)
- [Setup / System Onboarding Workflow](./ideas/workflows/setup-system-onboarding.md)
- [Shape / Idea Interview Workflow](./ideas/workflows/shape-idea-interview.md)
...
- [Blank Slate Onboarding Workflow](./plans/initial-assistant-workflows/blank-slate-onboarding.md)
- [Review / Status Briefing Workflow](./plans/initial-assistant-workflows/review-status-briefing.md)
- [Setup / System Onboarding Workflow](./plans/initial-assistant-workflows/setup-system-onboarding.md)
- [Shape / Idea Interview Workflow](./plans/initial-assistant-workflows/shape-idea-interview.md)
...
- [Initial Assistant Workflows](./projects/initial-assistant-workflows.md)
...
- [Research Github Repo](./prompts/research-github-repo.md)
- [Write a code tutorial](./prompts/write-a-code-tutorial.md)
...
- [Creating Assistants](./demos/creating-assistants.md)
- [I-Message Integration](./demos/imessage-integration.md)
- [Creating Assistant Workflows](./guides/creating-assistant-workflows.md)
...
- [Setting up Multiple GWS Profiles](./guides/setting-up-multiple-gws-profiles.md)
- [Window Manager Layouts](./guides/window-manager-layouts.md)
- [Blank Slate Onboarding Workflow — Build Report](./project-builds/initial-assistant-workflows/blank-slate-onboarding.md)
- [Review / Status Briefing Workflow — Build Report](./project-builds/initial-assistant-workflows/review-status-briefing.md)
- [Setup / System Onboarding Workflow — Build Report](./project-builds/initial-assistant-workflows/setup-system-onboarding.md)
- [Shape / Idea Interview Workflow — Build Report](./project-builds/initial-assistant-workflows/shape-idea-interview.md)
